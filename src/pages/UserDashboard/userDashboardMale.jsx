        ...
        <div className={styles.apps}>
         {/* Settings is the box to edit the user data */}
            ...
            <div className={styles.rearrange}>
              ...
              <div className={styles.save}>
                <button><Link to="/"> <img src={map} alt='icon'/> find a SweatMate </Link> </button>
              </div>
              <div className={styles.save}>
                <button><Link to="/progress"> <img src={donut} alt='icon'/> my Progress </Link> </button>
              </div>
              <div className={styles.save}>
                <button><Link to="/personaltrainer"> <img src={insight} alt='icon'/> From PT </Link> </button>
              </div>
              <div className={styles.save}>
                <button><Link to="/mealPlanner"> <img src={fruit} alt='icon'/> Meal Plan </Link> </button>
              </div>
